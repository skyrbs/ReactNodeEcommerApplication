...
const SalesCustomers = () => {
    ...
    const newCustomer = () => (
        <div className="mt-3 mb-3">
            <Link to="/salesadmin/newcustomer"> Create New Customer </Link>
        </div>
    );
    ...
    const columns =[
        ...
        { 
            Header: "Edit",
            Cell: e =><Link to={`/salesadmin/salescustomersdetails/${e.original._id}`}>
            ...
            <div className="row">
                ...
                <div className="col-12">
                    <h2 className="text-center">
                        Customer List are : {salesusers.length}
                    </h2>
